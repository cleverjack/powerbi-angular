...
export class NgxPowerBiComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  // Public properties
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (this.ngxPowerBiIFrameRef && this.ngxPowerBiIFrameRef.nativeElement && this.validateRequiredAttributes()) {
